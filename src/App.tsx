...
이곳의 대표 시그니처 메뉴인 청정 생오리 소금구이는 육질의 때깔부터가 남달랐는데요. 참숯 화력이 아주 강력해서 불판에 올리자마자 퍼지는 고소한 향과 함께 표면에 육즙이 송골송골 맺히며 노릇노릇하게 구워지기 시작했습니다. 압구정로데오 오리고기 맛집답게 인공적인 잡내나 누린내는 눈 씻고 찾아봐도 없었고, 한 입 씹을 때마다 쫄깃하게 터지는 식감이 그야말로 예술이었어요.

[실제첨부 사진 3] - 활활 불타오르는 국산 특참숯 위에 석쇠 오리구이가 올라간 매혹적인 항공샷

여기에 더해, 단체로 방문했을 때 오순도순 이야기를 나누기 적합한 부스석과 단독 프라이빗 룸이 마련되어 있어 압구정로데오 회식 맛집으로 예약 전부터 이미 입소문이 자자했던 이유를 온몸으로 실감할 수 있었습니다. 특히 매장이 엄격하게 위생을 신경 쓰고 세련된 무드로 연출되어 있어 젊은 커플들의 트렌디한 압구정 감성 데이트 코스로도 대단히 높은 점수를 주고 싶네요.

| 추천 메뉴 | 가격 | 한줄 평가 / 특징 |
|---|---|---|
| 숯불 청정 생오리구이(판) | 59,000원 | 잡내 0% 국산 무항생제 생오리의 육즙 폭발 시그니처 |
| 매콤 비법 오리주물럭 | 62,000원 | 비법 고추장 양념과 대파가 어우러진 특제 감칠맛 |
| 가마솥 영양 오리백숙 | 85,000원 | 한약재를 듬뿍 달여 원기 회복에 타의 추종을 불허하는 깊은 맛 |
